...
- Ultimo paso completado: `09 - Panel de barbero`.
- Proximo paso recomendado: `10 - Modulo de autocaja`.
- Archivo prompt base del proximo paso: `ai/agent-tasks/phase-1/10-autocaja-module.md`.
