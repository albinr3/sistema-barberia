...
- `PayrollPage` usa chrome de pantalla completa como Cash Box/Local Admin y se conecta a `PayrollService` para generar semanas viernes-jueves, aplicar ajustes manuales, registrar pago semanal completo y bloquear cambios sobre periodos pagados.
