...
- Pantallas de kiosco, pantalla publica, panel de barbero con validacion de estacion antes de iniciar tickets, autocaja, administracion local, reportes y nomina semanal.
