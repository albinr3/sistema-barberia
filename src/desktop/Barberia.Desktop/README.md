...
- `PayrollPage` usa chrome de pantalla completa como Cash Box/Local Admin y se conecta a `PayrollService` para generar vistas previas de semanas viernes-jueves, guardar ajustes manuales pendientes en SQLite hasta registrar el pago semanal completo y bloquear cambios sobre periodos pagados.
