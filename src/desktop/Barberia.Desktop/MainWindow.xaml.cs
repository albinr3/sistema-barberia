...
public sealed partial class MainWindow : Window
{
    ...
    private Page CreateModulePage(ShellModuleDefinition module)
    {
        ...
        else if (page is BarberPublicPage barberPublicPage)
        {
            barberPublicPage.ShellMenuRequested += (_, _) => ShowShellMenu();
        }
        else if (page is BarberCheckInPage barberCheckInPage)
        {
            barberCheckInPage.ShellMenuRequested += (_, _) => ShowShellMenu();
        }
