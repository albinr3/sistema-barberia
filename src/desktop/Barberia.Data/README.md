...
- Exponer el historial de tickets con tres tiempos operativos: creacion/check-in desde `turns.checked_in_at`, inicio de servicio desde `turns.started_at` y cobro desde `cash_payments.collected_at`.
