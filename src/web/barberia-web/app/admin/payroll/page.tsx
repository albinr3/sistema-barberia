    ...
    <AppShell title="Payroll Management" variant="admin">
      <div className={styles.page}>
        ...
        <section className={styles.kpiGrid}>
          ...
          <Kpi label="Manual Adjustments" value={formatCurrency(period?.total_adjustments_cents ?? 0)} />
        ...
        <section className={styles.payrollFooter}>
          <label>
            <span>Payroll Reference</span>
            <input value={payrollReference(period, range)} readOnly />
          </label>
        </section>
      </div>
    </AppShell>
